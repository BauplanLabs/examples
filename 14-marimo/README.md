...
Sign up for a free account in the Bauplan sandbox [here](https://accounts.bauplanlabs.com/sign-up) and get your API key from the dashboard. Follow the docs to [configure your key](https://docs.bauplanlabs.com/tutorial/installation).
